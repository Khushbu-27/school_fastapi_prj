...
@google_login_router.get("/auth/login/callback", tags=["Google login"], summary="Google Login Callback")
...
@google_login_router.get("/protected-endpoint", tags=["Google login"])
