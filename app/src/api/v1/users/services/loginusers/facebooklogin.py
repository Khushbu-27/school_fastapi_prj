...
facebook_login_router = APIRouter()

@facebook_login_router.get(
    "/auth/facebook-login",
    tags=["facebook login"],
...
@facebook_login_router.get("/auth/facebook-login/callback", tags=["facebook login"], summary="Facebook Login Callback")
