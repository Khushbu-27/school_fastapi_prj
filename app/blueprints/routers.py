...
from app.src.api.v1.users.views.admin_views import admin_router 
from app.src.api.v1.users.views.admin_service_views import admin_serv_router
from app.src.api.v1.users.views.user_views import user_router
from app.src.api.v1.users.views.teacher_views import teacher_serv_router
from app.src.api.v1.users.views.student_views import student_serv_router
